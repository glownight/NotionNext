...
const BLOG = {
    ...
    AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'glownight', // 您的昵称 例如 tangly1024
    BIO: process.env.NEXT_PUBLIC_BIO || '一个前端', // 作者简介
    LINK: process.env.NEXT_PUBLIC_LINK || 'https://glownight.cn', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,glownight', // 网站关键词 英文逗号隔开
  
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@t.com
    ...
    WIDGET_PET_LINK:
      ...
      'https://cdn.jsdelivr.net/npm/live2d-widget-model-hibiki@1.0.5/assets/hibiki.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
